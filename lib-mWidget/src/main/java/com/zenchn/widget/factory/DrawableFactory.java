package com.zenchn.widget.factory;
...
public class DrawableFactory {
     ...
     * @return
     */
    public static GradientDrawable createDrawable(int mSolidColor, int mLineWidth, int mLineColor, float mRadius) {
        GradientDrawable drawable = new GradientDrawable();
        drawable.setColor(mSolidColor);
        drawable.setStroke(mLineWidth, mLineColor);
        drawable.setGradientRadius(mRadius);
        return drawable;
    }
